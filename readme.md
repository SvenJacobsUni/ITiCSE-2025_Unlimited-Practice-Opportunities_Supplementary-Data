...
For our submission to iTiCSE 2025 we provide here the supplementary data anonymously. This includes both the prompts used and the tasks generated in German (original) and English (translated). 
...
- To test the model solution with the unit tests, we used our own open source code execution environment (anonymous).
